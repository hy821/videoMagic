...
//首页顶部分类接口
#define HomeCategoryUrl           @"module/lst/1"
//首页轮播图
...
//-----视频播放详情页------//
//公有: 视频播放详情页
#define VideoDetail_CommonUrl   @"media/info/1"
//公有: 猜您喜欢 (ps:详情页短视频, 猜你喜欢用智能推荐接口)
#define VideoDetail_GuessULikeUrl @"prog/lst/rel/1"
//请求集数
#define VideoDetail_NumberOfEpisodeUrl @"media/tip/1"
//全部剧集里的剧集介绍
#define AllEpisodeIntroUrl @"media/story/1"
//视频Url解析
#define AnalyseVideoUrlUrl   @"analysis/get/1"
//视频收藏
#define VideoCollectUrl @"collect/ins/1"
//取消收藏
#define VideoCancelCollectUrl @"collect/del/1"
//评论列表
#define VideoDetailCommentListUrl @"comment/lst/2"
//子评论列表
#define SubCommentListUrl @"comment/lst/4"
//回复
#define ReplyCommentUrl @"comment/ins/2"
//点赞评论
#define LikeOrSetOnCommentUrl @"comment/act/1"
...
// 短视频 播放 列表页 & 详情页短视频的猜你喜欢, 用智能推荐接口
