...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.normalColor = KCOLOR(@"#4A4A4A");
        self.highlightedColor = KCOLOR(@"#FF5C3E");
        ...
        _seperatorView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.1];
...
- (void)reloadTabBar {
    ...
    _indicatorView.frame = CGRectMake(0, CGRectGetHeight(self.bounds) - 3, cellWidth, 3);
